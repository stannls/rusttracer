...
impl Scene {
    pub fn new(aspect_ratio: f64, image_width: usize, viewport_height: f64, camera_position: Vec3, focal_length: f64) -> Scene {
        Scene { aspect_ratio, image_width, image_height: (image_width as f64 / aspect_ratio) as usize, viewport_height, viewport_width: viewport_height * (image_width as f64 / (image_width as f64 / aspect_ratio)), camera_position, focal_length }
    }
    ...
    pub fn render(&self) -> Image {
        ...
        let viewport_upper_left = self.camera_position - Vec3::new(0.0, 0.0, self.focal_length);
